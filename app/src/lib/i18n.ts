...
const en = {
  ...
  preparingAccount: 'Preparing your smart account…',
  repoTitle: 'Source & on-chain evidence (GitHub)',
  soundOn: 'Sound effects on — click to mute',
  soundOff: 'Sound effects muted — click to unmute',
  errUserRejected: 'You declined the request in MetaMask — nothing was signed or sent.',
  errDismiss: 'Dismiss',
  ...
  nodeTips: {
    ...
    burner: 'A throwaway relay account that sponsors the gasless cast: an EOA upgraded to a smart account via EIP-7702. It holds 0 ETH, fronts the 7710 bundle, and pays every fee in USDC.',
  ...
  relayGasLabel: 'gas · 1Shot fronts',
...
const zh: Dict = {
  ...
  notConnected: '未连接',
  connect: '连接 MetaMask',
  preparingAccount: '正在准备你的智能账户…',
  repoTitle: '源码与链上证据 (GitHub)',
  soundOn: '音效已开启 — 点击静音',
  soundOff: '音效已静音 — 点击开启',
  errUserRejected: '你在 MetaMask 中取消了该请求——未签署或发送任何内容。',
  errDismiss: '关闭',
  hearVerdict: '听 AI 宣读裁决',
  hearVerdictPlaying: '宣读中…',
  hearVerdictTitle: '终裁朗读其裁决理由 — Venice /audio/speech（第二种 Venice 模态）',
  ...
  nodeTips: {
    you: '你的 MetaMask 智能账户。只签一次 ERC-7710 委托，仅限投票、有票数上限、到期失效，且随时可用 Recall 杀掉整条授权链。',
    orch: '一号代理。持有你的根委托，再以更窄的范围转授给分析师。子委托只能收窄权限，不能放大。',
    fiscal: 'TEE 四视角之一。审预算纪律：开支规模、放款结构、财政影响。',
    ...
    burner: '一次性中继账户，为这次免 gas 投票垫付：EOA 经 EIP-7702 升级为智能账户。持有 0 ETH，垫付 7710 bundle，所有费用都用 USDC 支付。',
