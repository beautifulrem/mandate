...
const en = {
  ...
  oneShotMechGas: 'gas (ETH) · 1Shot pays it',
  oneShotMechGasAmt: 'burner 0 ETH',
  oneShotMechNote: 'The agent pays every fee in USDC and never holds ETH. 1Shot relays the vote and pays the real ETH gas (357,994 gas).',
...
const zh: Dict = {
  ...
  oneShotMechGas: 'gas（ETH）· 由 1Shot 垫付',
  oneShotMechGasAmt: 'burner 0 ETH',
  oneShotMechNote: '代理全程用 USDC 付费、不持 ETH。1Shot 中继投票并垫付真实 ETH gas（357,994 gas）。',
