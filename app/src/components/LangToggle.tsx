...
export function LangToggle({ lang, onToggle }: { lang: Lang; onToggle: () => void }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-chip border border-hairline bg-surface/70 px-3 py-1.5 text-xs font-bold text-ink-soft shadow-none backdrop-blur transition-colors duration-150 hover:border-brand/50 hover:bg-surface-2 hover:text-brand hover:shadow-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
    >
